...
import SEO, { OrganizationSchema, WebSiteSchema, ProductSchema, BreadcrumbSchema, FAQSchema, ArticleSchema } from '../SEO'
...
describe('ProductSchema', () => {
  it('renders Product schema with provided props', () => {
    const props = { name: 'Test Watch', description: 'A fine watch', image: 'watch.jpg', sku: 'W001', brand: 'Rolex' }
...
describe('BreadcrumbSchema', () => {
  it('renders BreadcrumbList schema', () => {
    const items = [{ name: 'Home', url: '/' }, { name: 'Category', url: '/category' }]
