        ...
        <div className="min-h-screen bg-white text-black py-12 px-6 md:px-12 lg:px-24 max-w-5xl mx-auto">
            ...
            <div className="mb-10 font-sans text-gray-700 leading-relaxed">
                <p className="text-lg font-serif text-black italic">
                    At The Collectors Exchange, we believe that privacy is a cornerstone of trust. We are not a data-driven "innovation" company; we are a heritage-driven business. We do not "mine" your life for insights; we only collect what is necessary to ensure the "Truth" of our exchange.
                </p>
            </div>
            ...
            <div className="space-y-10 font-sans text-gray-800">
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">1. Our Stance on Data (The Anti-Startup Rule)</h2>
                    <p className="text-gray-700">We reject the modern practice of treating customers as data points. We do not sell, rent, or trade your personal information to third-party advertisers or "big tech" aggregators. Doing so would be "cheap" behavior that contradicts our ancestral business values.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">2. What We Collect (The Custodian Identity)</h2>
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">3. The "Registry of History" & Annual Health Checks</h2>
                    <p className="mb-3 text-gray-700">Unique to our mission, we maintain a registry of every historic article we sell.</p>
                    <p className="mb-2 font-medium text-black">Purpose:</p>
                    <p className="mb-3 text-gray-700">We keep your contact information linked to the specific article so we can perform our Annual Health Checks.</p>
                    <p className="mb-2 font-medium text-black">The Goal:</p>
                    <p className="text-gray-700">If a rare part for your 100-year-old timepiece becomes available, or if we have updated information on the provenance of your antique, we need to know how to find you. You are the custodian; we are the record-keepers.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">4. Digital Discretion (Cookies & Tracking)</h2>
                    <p className="mb-3 text-gray-700">While we use a digital platform to reach "netizens," we keep our digital footprint lean.</p>
                    <p className="mb-2 font-medium text-black">Minimal Tracking:</p>
                    <p className="mb-3 text-gray-700">We use only essential cookies required for the website to function. We do not use invasive "pixel" tracking to follow you across the internet.</p>
                    <p className="mb-2 font-medium text-black">Payment Security:</p>
                    <p className="text-gray-700">We use high-integrity, encrypted payment gateways. We never see and therefore never store your credit card numbers or bank credentials. That is a responsibility we leave to the financial "doctors."</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">5. Third-Party "Necessities"</h2>
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">6. Your Rights (The "Handshake" Agreement)</h2>
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">7. Security (The Vault)</h2>
                    <p className="text-gray-700">We protect your data with the same seriousness as we protect a limited-edition timepiece. Our digital "vaults" are monitored and encrypted to prevent unauthorized access by those who do not value heritage as we do.</p>
                </section>
            </div>
            ...
            <div className="mt-16 p-8 bg-heritage-cream border border-luxury-gold/20 rounded-sm">
                ...
                <p className="font-serif italic text-lg text-heritage-charcoal leading-relaxed">
                    "A man's collection and his business dealings should be his own. We keep your data private because that is how a business of integrity operates. We are here to keep history alive, not to sell your habits to the highest bidder."
                </p>
