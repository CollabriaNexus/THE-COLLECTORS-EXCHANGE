    ...
    <div className="min-h-screen bg-heritage-cream">
      ...
      <section className="relative h-[60vh] sm:h-[65vh] lg:h-[70vh] min-h-[400px] sm:min-h-[450px] lg:min-h-[500px] flex items-center justify-center overflow-hidden bg-heritage-charcoal">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1618331835717-801e976710b2?q=80&w=1600&auto=format&fit=crop')",
          }}
        >
        ...
        <div className="relative z-20 container mx-auto px-4 sm:px-6 text-center">
          <div className="flex items-center justify-center gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <span className="text-luxury-gold uppercase tracking-[0.2em] sm:tracking-[0.3em] text-[10px] sm:text-xs font-bold">
              Coming Soon
            </span>
            <div className="h-px w-8 sm:w-12 bg-luxury-gold/50"></div>
          </div>
      ...
      <section className="py-20 sm:py-28 px-6">
        <div className="container mx-auto max-w-3xl text-center">
          <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-heritage-charcoal/5 flex items-center justify-center mx-auto mb-8">
            <Gavel
              size={36}
              className="text-heritage-gold-muted/60 sm:w-[44px] sm:h-[44px]"
              strokeWidth={1}
            />
          </div>
          ...
          <p className="text-heritage-charcoal/60 text-base sm:text-lg leading-relaxed max-w-xl mx-auto mb-4">
            Our auction house is being prepared for its inaugural season. We are curating an
            exceptional collection of artifacts that will be presented to discerning collectors like
            you.
          </p>
