...
const FAQ_ITEMS = [
    ...
    },
    {
        category: 'Selling',
        questions: [
            { q: 'How do I start selling on The Exchange?', a: 'Create an account, complete identity verification (KYC), accept the Seller Agreement, and submit your items for brokerage. Once approved by our curation team, your items will be listed on The Exchange.' },
            { q: 'What are the seller fees?', a: 'Individual sellers can list up to 5 items. Company accounts have unlimited listings. Platform fees are deducted at the time of sale.' },
            { q: 'How do I get paid?', a: 'Payments for sold items are held for 7 days after delivery to allow for buyer inspection. After this period, funds become available for payout.' },
            { q: 'What items can I sell?', a: 'We accept timepieces, collectibles, antiques, jewelry, toys & pop culture items. All items must be authentic and accurately described. Our curation team reserves the right to reject any listing.' },
            { q: 'How long does verification take?', a: 'KYC verification is typically completed within 48 hours. Product listing review times vary based on the current volume.' },
        ]
    },
    {
        ...
        questions: [
            ...
            { q: 'How do I delete my account?', a: 'Please contact our support team at support@thecollectorsexchange.in with your account details, and we will assist you with account deletion.' },
    ...
    },
    {
        ...
        questions: [
            { q: 'How are items shipped?', a: 'Items are shipped via Delhivery, our logistics partner. Tracking IDs are provided once the order is shipped from our verification center.' },
            { q: 'What are the shipping costs?', a: 'Shipping is free for all orders within India. International shipping costs vary based on the item and destination.' },
            { q: 'How long does delivery take?', a: 'Domestic orders typically arrive within 5-7 business days after processing. International delivery times vary.' },
            { q: 'Do you ship internationally?', a: 'Yes, we ship to select international destinations. Please contact our support team for international shipping inquiries.' },
        ]
    },
];
                                ...
                                {category.questions.map((item, qIdx) => {
                                    ...
                                    return (
                                        <div key={qIdx} className="bg-white border border-gray-100 shadow-sm">
                                            <button onClick={() => toggleItem(catIdx, qIdx)}
                                                className="w-full flex items-center justify-between p-5 text-left hover:bg-gray-50 transition-colors">
                                                <span className="font-medium text-heritage-charcoal pr-4">{item.q}</span>
                                                {isOpen ? <ChevronUp size={18} className="text-luxury-gold flex-shrink-0" /> : <ChevronDown size={18} className="text-gray-400 flex-shrink-0" />}
                                            </button>
                                            {isOpen && (
