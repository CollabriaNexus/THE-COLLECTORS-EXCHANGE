    ...
    return (
        <div className="min-h-screen bg-white text-black py-12 px-6 md:px-12 lg:px-24 max-w-5xl mx-auto">
            ...
            <div className="mb-10 font-sans text-gray-700 leading-relaxed">
                <p className="mb-4">
                    This Seller Agreement is entered into between <strong>Collectors Exchange</strong> ("Platform," "we," "us," or "our") and the undersigned seller ("Seller," "you," or "your"). By registering, listing, or selling on the Platform, you agree to be bound by this Agreement.
                </p>
            </div>
            ...
            <div className="space-y-10 font-sans text-gray-800">
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">1. Seller Categories</h2>
                    <h3 className="text-lg font-serif font-medium mb-2 text-heritage-bronze">1.1 Individual Collectors</h3>
                    <p className="mb-3 text-gray-700">Individual sellers may list and sell up to <strong>5 products at a time</strong> on the Platform, unless otherwise approved in writing by the Platform.</p>
                    <h3 className="text-lg font-serif font-medium mb-2 text-heritage-bronze">1.2 Company-led Resellers</h3>
                    <p className="text-gray-700">Registered business sellers, resellers, and commercial entities may list <strong>unlimited products</strong>, subject to Platform approval, policy compliance, and operational review.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">2. Verification Requirements</h2>
                ...
                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">9. Compliance With Law</h2>
                    <p className="text-gray-700">The Seller agrees to comply with all applicable laws, including tax, consumer protection, product authenticity, and e-commerce regulations.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">10. Amendments</h2>
                    <p className="text-gray-700">The Platform may update this Agreement at any time by posting a revised version. Continued use of the Platform after updates means acceptance of the revised terms.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">11. Governing Law</h2>
                    <p className="text-gray-700">This Agreement shall be governed by the laws of the Republic of India, and disputes shall be subject to the jurisdiction of Bangalore, Karnataka.</p>
                </section>

                <section>
                    <h2 className="text-2xl font-serif font-semibold mb-4 text-black">12. Acceptance</h2>
                    <p className="text-gray-700">By signing up, listing products, or selling through the Platform, the Seller acknowledges that they have read, understood, and agreed to this Seller Agreement.</p>
                </section>
            </div>
        </div>
    );
