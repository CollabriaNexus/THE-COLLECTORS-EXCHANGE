// Marketing images served responsively from public/img (generated by
// scripts/optimize-assets.cjs — 480w & 800w WebP variants).
...
const aboutSeo = CORE_PAGES['/about'];
      ...
      <section className="hero-bleed relative min-h-[60vh] sm:min-h-[75vh] lg:min-h-[90vh] flex items-center justify-center overflow-hidden border-b border-heritage-bronze/10 bg-heritage-charcoal">
        <div className="absolute inset-0 z-0">
          <img
            ...
            srcSet="/img/about-us-480.webp 480w, /img/about-us-800.webp 800w"
            sizes="100vw"
            alt=""
            fetchPriority="high"
          ...
          <Reveal direction="left" blur className="space-y-8 sm:space-y-12">
            ...
            <div className="p-6 sm:p-10 lg:p-12 bg-white rounded-sm border border-heritage-bronze/10 relative overflow-hidden shadow-heritage">
              ...
              <p className="text-heritage-brown leading-relaxed text-sm sm:text-base font-medium">
                Finding that one dream watch or a relic that honors the memory of your forefathers
                shouldn't require endless hours of digital rabbit holes or navigating the
                uncertainty of local markets.
              </p>
              <p className="text-heritage-brown leading-relaxed text-sm sm:text-base font-medium mt-4">
                We exist to bridge the gap between the hunt and the heritage. By sourcing only 100%
                original and authentic articles, we do the heavy lifting so you can focus on what
          ...
          <Reveal direction="right" blur className="flex flex-col h-full">
            <div className="h-full p-6 sm:p-10 bg-heritage-beige/30 border border-heritage-bronze/10 rounded-sm hover:border-heritage-bronze/30 transition-all duration-500 hover:shadow-heritage group">
              <History
                ...
                strokeWidth={1}
              />
              <h3 className="text-lg sm:text-2xl font-serif mb-4 sm:mb-6 text-heritage-charcoal">
                Mission: Reviving the Soul of Indian Heritage
              </h3>
              <div className="space-y-4 sm:space-y-6 text-sm text-heritage-brown/80 leading-relaxed font-light">
                <p>
                  In an era dominated by the digital, the tangible history of India is at risk of
                  fading away. Our mission is to reclaim that "dead value" and bring it back to
                  life. We don't just trade articles; we preserve stories.
                </p>
                <p>
                  We act as the lifejacket for our national heritage, ensuring that every
                  collectible is backed by trust and authenticity. We are dedicated to educating the
                  next generation of collectors, helping them understand and protect the true worth
                  of the past.
                </p>
                <p className="text-heritage-bronze font-semibold uppercase tracking-wider text-xs">
                  The Collectors Exchange was built to end that struggle.
                </p>
              </div>
            </div>
          </Reveal>
      ...
      <section className="py-16 sm:py-24 lg:py-32 bg-white relative overflow-hidden border-y border-heritage-bronze/10">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <Reveal className="text-center mb-12 sm:mb-20">
            ...
            <h2 className="text-xl sm:text-3xl lg:text-4xl font-serif mb-6 text-heritage-charcoal">
              Our Belief
            </h2>
          ...
          <Stagger className="grid md:grid-cols-3 gap-0 border border-heritage-bronze/10 bg-heritage-cream shadow-sm">
            <div className="p-6 sm:p-10 lg:p-14 border-b md:border-b-0 md:border-r border-heritage-bronze/10 text-center group hover:bg-white transition-all duration-500">
              <Compass
                ...
                strokeWidth={1.5}
              />
              <p className="text-sm sm:text-lg font-serif italic text-heritage-charcoal/80 group-hover:text-heritage-charcoal transition-colors">
            ...
            <div className="p-6 sm:p-10 lg:p-14 text-center group hover:bg-white transition-all duration-500">
              ...
              />
              <p className="text-sm sm:text-lg font-serif italic text-heritage-charcoal/80 group-hover:text-heritage-charcoal transition-colors">
                "Every buyer understands they are acquiring more than an object: they are acquiring
                a legacy"
              </p>
            </div>
          </Stagger>
        ...
        <div className="max-w-5xl mx-auto space-y-32">
          ...
          <div className="flex flex-col md:flex-row gap-20 items-center">
            <Reveal direction="left" blur className="md:w-1/2">
              ...
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-serif mb-6 sm:mb-8 text-heritage-charcoal">
                Truth Over Misbranding
              </h2>
              <p className="text-sm sm:text-base md:text-lg text-heritage-gold-muted italic font-serif mb-6 sm:mb-8 border-l-2 border-luxury-gold/30 pl-4 sm:pl-6">
                You cannot ask a cobbler to stitch a wound and call him a doctor.
              </p>
              <div className="space-y-4 sm:space-y-6 text-heritage-brown/80 text-sm sm:text-base leading-relaxed font-light">
                <p>
                  While many brands sell "lifestyle" through clever marketing, we sell the Truth. We
                  specialize in the mechanical heartbeat of history and the raw authenticity of
                  heritage. If it isn't genuine, it isn't on our platform. Period.
                </p>
                <p>
                  Each item listed on The Collectors Exchange undergoes a rigorous internal
                  verification process. Our focus is not volume, but integrity. We choose curation
          ...
          <div className="space-y-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: 'The Seasoned Collector',
                  desc: 'Refining a lifetime archive with precision and care.',
                },
                {
                  title: 'The Inheritor',
                  desc: 'Seeking a respectful, trusted place for family treasures.',
                },
                {
          ...
          <div className="bg-heritage-charcoal p-8 sm:p-12 lg:p-24 text-center shadow-2xl relative overflow-hidden">
            ...
            <Reveal className="relative z-10">
              <ShieldCheck
                ...
                strokeWidth={1}
              />
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-serif mb-4 sm:mb-6 text-white">
                Stewardship, Not Just Sales
              </h2>
              <p className="text-heritage-beige/60 mb-8 sm:mb-12 text-base sm:text-lg md:text-xl italic font-serif">
                "Most businesses end their relationship with you at the checkout. We are just
                getting started."
              </p>
              <p className="text-heritage-beige/70 mb-8 sm:mb-12 text-sm sm:text-base md:text-lg font-light leading-relaxed max-w-2xl mx-auto">
                As stewards of Indian history, we provide annual "health checks" for the articles
                you purchase. We stay in touch to ensure your timepieces and collectibles are
                preserved correctly, honoring the lineage they represent.
              </p>
              ...
              <div className="inline-flex flex-col sm:flex-row justify-center gap-6 sm:gap-16 border-t border-white/10 pt-8 sm:pt-12">
                <div className="flex items-center gap-4 justify-center">
                  ...
                  <span className="text-base sm:text-lg md:text-xl font-serif text-white/90">
                    Ancestral Integrity
                  </span>
                </div>
                <div className="flex items-center gap-4 justify-center">
          ...
          <Reveal className="space-y-6 sm:space-y-8">
            <div className="space-y-3 sm:space-y-4">
              ...
              <h2 className="text-xl sm:text-3xl lg:text-4xl font-serif text-heritage-charcoal tracking-tight uppercase">
                A New Standard of Trust
              </h2>
            </div>
            <div className="space-y-4 sm:space-y-6 text-heritage-charcoal/80 text-sm sm:text-base md:text-lg leading-relaxed font-medium border-l-2 border-luxury-gold/20 pl-4 sm:pl-8">
              <p>The pre-owned market is often clouded by doubt. We're here to change that.</p>
              <p>
                Through a rigorous verification process and archival appraisal, we ensure that every
                piece in our registry is original and authentic. We're creating a space where
          ...
          <div className="grid md:grid-cols-2 gap-20 items-start">
            <Reveal direction="left" blur className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-4 sm:space-y-6 text-heritage-charcoal/80 text-sm sm:text-base md:text-lg leading-relaxed font-medium border-l-2 border-luxury-gold/20 pl-4 sm:pl-8">
                <p>
                  By eliminating unnecessary middlemen and sourcing directly from local street
                  markets and private sellers, we provide unparalleled value.
                </p>
                <p>
                  We handle everything, from careful verification to global shipping, ensuring that
        ...
        <div className="container mx-auto px-6 max-w-4xl text-center">
          ...
          <Stagger className="space-y-6 sm:space-y-8 text-sm sm:text-base md:text-lg lg:text-xl text-white/70 font-light leading-relaxed font-serif italic max-w-3xl mx-auto">
            <p>
              ...
              markets and experts to bridge the gap between local street markets and global
              collections.
            </p>
            <p>
          ...
          <div className="grid md:grid-cols-2 gap-12 sm:gap-16 items-start">
            <Reveal direction="left" blur className="space-y-8 sm:space-y-12">
              <div className="space-y-3 sm:space-y-4">
                ...
                <h2 className="text-xl sm:text-3xl lg:text-4xl font-serif text-heritage-charcoal leading-tight">
                  A Letter from <br />
                  Our Founder
                </h2>
              </div>
              <div className="relative p-6 sm:p-12 bg-heritage-cream border border-heritage-bronze/10">
                ...
                <div className="space-y-4 sm:space-y-6 text-sm sm:text-base md:text-lg text-heritage-charcoal/90 font-serif italic leading-relaxed">
                  <p>
                    "Growing up, I was always fascinated by the stories objects tell. A simple watch
                    isn’t just about keeping time; it’s about the person who wore it, the milestones
                    they reached, and the legacy they left behind."
                  </p>
                  <p>
                    "At The Collectors Exchange, we don’t just sell items. We connect you with
                    pieces of history that have been carefully sourced and verified. Thank you for
