...
describe('useMediaQuery', () => {
  ...
  it('re-registers listener when query changes', async () => {
    ...
    addEventListenerSpy
      .mockImplementationOnce((event, handler) => { firstHandler = handler })
      .mockImplementationOnce((event, handler) => { secondHandler = handler })
    mockMatchMedia.mockReturnValue({
      matches: false,
      addEventListener: addEventListenerSpy,
      removeEventListener: removeEventListenerSpy,
  ...
  it('defaults to false when window is undefined', async () => {
