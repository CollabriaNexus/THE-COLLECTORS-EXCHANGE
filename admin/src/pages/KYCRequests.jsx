...
function KYCRequests() {
  ...
  // The API returns EVERY user when no status is given, so "All Statuses"
  // buries the handful of submissions that actually need a decision. The
  // queue an operator opens this page to work is the pending one.
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-3xl font-serif font-bold text-heritage-charcoal">KYC Requests</h2>
        <p className="text-gray-600 mt-2">Review and manage user KYC submissions</p>
      </div>
        ...
        <Table
          ...
          emptyMessage={
            statusFilter === 'pending'
              ? 'No pending KYC requests — nothing is waiting on you.'
