...
const AI_BLOG_INSTRUCTIONS = {
  ...
  contentFormatting: {
    heading:
      'Use <h2> for major sections. Use <h3> for subsections within a section. Never skip levels (h2 → h3, never h2 → h4). Use at most 6-8 sections per article.',
    paragraphs:
      'Wrap every paragraph in <p> tags. Each paragraph should be 2-4 sentences. Use a lead paragraph (<p class="lead">) for the opening.',
    emphasis: 'Use <strong> for bold, <em> for italics. Avoid excessive formatting.',
    links:
      'Use <a href="..."> for references. External links should open in new tabs (target="_blank" rel="noopener noreferrer"). Use https://thecollectorsexchange.in for internal links.',
    blockquotes:
      'Use <blockquote> for pull quotes, expert quotes, or memorable excerpts from the article. Place one quote every 2-3 sections for visual rhythm.',
    lists: 'Use <ul>/<ol> with <li> for bullet points or numbered steps. Keep lists concise.',
    images:
      'Use <img src="..." alt="..." loading="lazy" /> within <figure> tags. Add <figcaption> for image captions. Use high-quality Unsplash images (https://images.unsplash.com/...). Images should be 1200px+ wide. Do NOT use placeholder images or logos.',
  ...
  contentStructure: {
    title:
      'Compelling, 8-14 words. Use a subtitle pattern with || separator for depth. Example: "The Art of Time: An Introduction to Horology"',
    excerpt:
      '1-2 sentences (25-40 words). A hook that summarizes the article. Never use the same text as the opening paragraph.',
  ...
  seoGuidelines: {
    ...
    coverImage:
      'At least 1920x1080px. Provide a high-quality Unsplash URL. The image should be atmospheric and relevant to the topic.',
  },
  ...
  exampleResponse: {
    ...
    slug: 'art-of-time',
    excerpt:
      'From sundials to atomic clocks, the measurement of time is a story of human ingenuity. Explore the history, craftsmanship, and culture of horology.',
    category: 'Horology',
...
const AI_BLOG_SCHEMA = z.object({
  ...
  excerpt: z
    ...
    .max(200, 'Excerpt must be under 200 characters'),
